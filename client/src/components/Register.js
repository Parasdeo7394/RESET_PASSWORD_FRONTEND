...
const Register = () => {
    ...
    const addUserdata = async(e)=>{
       ...
       if(fname=== ""){
         ...
         alert("enter your cofirm password")
        }else if(cpassword.length< 6){
         alert ("cofirm password must be 6 char")
        }else if(password !== cpassword){
         alert("password and confirm password not match")
        }else{
            // console.log("user registration sucessfully done");
            ...
            if(res.status === 201){
                alert("user registration done sucessfully");
